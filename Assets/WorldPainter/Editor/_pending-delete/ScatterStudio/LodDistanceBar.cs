...
{
    /// <summary>
    /// IMGUI segmented LOD distance bar (Unity-LODGroup style).
    /// Step A — read-only render: LOD0/LOD1/LOD2 colored segments + Culled cap,
    ///           closeness-% labels (1 - dist/renderCullDistance), metres on hover.
    /// Step B — draggable handles that write back through SerializedProperty.ApplyModifiedProperties (SSOT).
    ///
