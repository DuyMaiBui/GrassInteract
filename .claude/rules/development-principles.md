...
After encountering ANY error (compile, runtime, gotcha), ALWAYS update the relevant skill with a gotcha/warning entry BEFORE continuing — then invoke `/t1k:sync-back`. See `docs/manual-correction-implies-skill-gap.md`.
