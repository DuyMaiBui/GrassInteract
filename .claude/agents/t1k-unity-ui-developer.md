...
model: sonnet
maxTurns: 40
tools: Glob, Grep, Read, Edit, MultiEdit, Write, Bash, WebFetch, WebSearch, AskUserQuestion, mcp__UnityMCP__manage_editor, mcp__UnityMCP__manage_scene, mcp__UnityMCP__manage_asset, mcp__UnityMCP__manage_gameobject, mcp__UnityMCP__manage_script, mcp__UnityMCP__manage_prefabs, mcp__UnityMCP__execute_menu_item, mcp__UnityMCP__read_console, mcp__UnityMCP__refresh_unity, mcp__UnityMCP__manage_camera, mcp__UnityMCP__manage_tools, mcp__UnityMCP__list_resources, mcp__UnityMCP__read_resource, mcp__UnityMCP__set_active_instance, mcp__UnityMCP__batch_execute, mcp__UnityMCP__telemetry_ping, mcp__UnityMCP__unity_docs
roles: [ui-developer]
