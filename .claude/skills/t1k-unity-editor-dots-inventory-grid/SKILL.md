...
- [`rules/manual-correction-implies-skill-gap.md`](../../rules/manual-correction-implies-skill-gap.md) — if you manually inject library/API knowledge into a teammate brief, that knowledge belongs in this skill, not the brief
