...
These are thought patterns that masquerade as productive but are actually symptoms of model over-confidence (especially in long-context sessions). If you catch yourself drafting one, STOP and return to Plan or Scout.
...
| "The score is 9.6/10, ship it" | Score is advisory, not approval. Artifacts decide. |
| "I'll skip the artifact gate, just this fix" | Bypassing the gate is bypassing the harness. Same risk as skipping tests. |
