...
def find_api_key():
    ...
    try:
        ...
        api_key = resolve_env('GEMINI_API_KEY', skill='t1k-extended-multimodal')
        ...
        if api_key:
            ...
            print_info("python ~/.claude/scripts/resolve_env.py GEMINI_API_KEY --skill t1k-extended-multimodal --verbose")
...
def provide_setup_instructions():
    ...
    print("\n4. Debug if needed:")
    print(f"   $ python ~/.claude/scripts/resolve_env.py --show-hierarchy --skill t1k-extended-multimodal")
    print(f"   $ python ~/.claude/scripts/resolve_env.py GEMINI_API_KEY --skill t1k-extended-multimodal --verbose")
